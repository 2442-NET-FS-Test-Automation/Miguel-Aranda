...
public class InMemoryLibraryRepository : ILibraryRepository
{
    ...
    {
        // OLD LIST BACKED METHOD FOR LOCKUP
        ...
        // New dictionary backed lockup code
    ...
    public bool Remove(int id)
    {
        ...
        if (_items.Remove(id)) // .Remove() - returns a true and removes the item if found, return false otherwise
        {
            Log.Information("Removed item with id {Id}", id); // log the removal
            return true;
        }
